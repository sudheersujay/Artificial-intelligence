...
# Mean moves: 8.61
# SD moves: 7.734084
# Time taken: 14.35848 seconds

# for n = 500
# Mean moves: 8.57
# SD moves: 7.452797
# Time taken: 67.95711 seconds
...
myFunction = function(moveInfo,readings,positions,edges,probs)
{
  ...
  else if(bp1 < 0 || bp2 < 0)#If backpacker dies
  {
    if (bp1 < 0) 
    {
      crocLocation = -1 * bp1 #Croc is at backpacker1 loc
      st[crocLocation] = 1
    }
    if (bp2 < 0) 
    {
      crocLocation = -1 * bp2#Croc is at backpacker2 loc
      st[crocLocation] = 1
    }
  } 
  else 
